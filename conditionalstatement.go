...
// NewStatement News a statement represented by the given name, that will evaluate to the given evaluation
func NewStatement[T any](name string, evaluation func(T) bool) *Statement[T] {
	return &Statement[T]{
		label: name,
		fn:    evaluation,
	}
